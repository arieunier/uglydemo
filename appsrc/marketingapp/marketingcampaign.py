...
MARKETFILE = "MarketingOperation/MarketingCampaign.html"
MARKETTHANKS = "MarketingOperation/MarketingCampaignThanks.html"
BRANDBLAZERS = "MarketingOperation/brand-blazers.html"
...
def brandblazers():
    try:
            ...
            data = render_template(BRANDBLAZERS,
